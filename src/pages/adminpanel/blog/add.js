...
const AddBLog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        data.append('category', formData.categoryName.join(','));
        data.append('doctor', formData.doctor.join(','));
        ...
        try {
            ...
            // const response = await axiosConfig.post('/add-blog', data, {
            //     headers: {
            ...
            errorToast('There was an error adding the Blog');
    ...
    return (
        <div className="full-container">
            <div className="section-header">
                ...
                <span className="main-heading heading-both">Add Blog</span>
            </div>
                                    ...
                                    <div className="input-outer">
                                        ...
                                        <Select
                                            ...
                                            value={categoryOptions.filter(option =>
                                                formData.categoryName.includes(option.value) // Filter selected options
                                            )}
                                    ...
                                    <div className="input-outer">
                                        ...
                                        <Select
                                            ...
                                            value={doctorOptions.filter(option =>
                                                formData.doctor.includes(option.value) // Filter selected options
                                            )}
