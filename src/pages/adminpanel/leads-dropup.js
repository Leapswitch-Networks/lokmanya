...
import {  View } from '../../assets/images/icons';
...
import { exportDatalead, getLeadListDropup, getLeadListnew, updateLeadStatus } from '@/ApiActions/CommonApi';
...
const Leads = () => {
  ...
  const getLeads = async (filters) => {
    try {
      const getLeads = await getLeadListDropup(filters);
