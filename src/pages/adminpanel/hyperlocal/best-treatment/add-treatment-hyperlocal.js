...
import { addBestTreatmentHyperlocal, getHyperlocalcategoryList } from '@/ApiActions/Admin/hyperlocaladmin/hyperlocal';
import { doctorsListFrontend } from "@/ApiActions/CommonApi";
...
const AddBestTreatment = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await addBestTreatmentHyperlocal(data);
